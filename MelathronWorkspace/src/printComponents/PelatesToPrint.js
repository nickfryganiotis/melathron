  ...
  return (
    <table className="tabel">
      ...
      <tfoot className="tfeet">
        <tr className="troo">
          <td>Ημ. Εκτύπωσης: {timeConverter(new Date(), false)}</td>
        </tr>
      </tfoot>
      ...
      <tbody>
        ...
        <tr className="troo">
          <tr className="troo">
            <td className="f1 bold">ΑΠΟ</td>
            <td className="f2 bold">ΠΩΛΗΤΗΣ</td>
            <td className="f3 bold">ΣΥΝΔΡΟΜΗ</td>
            <td className="f4 bold">ΠΟΣΟ</td>
          </tr>
          {sales.map((sale) => {
            return (
              <tr className="troo">
                ...
                <td className="f2 ">{sale["salesman_name"]}</td>
                <td className="f3 ">{sale["subscription_name"]}</td>
                <td className="f4 ">{sale["total_amount"]}</td>
              </tr>
            );
          })}
        </tr>
